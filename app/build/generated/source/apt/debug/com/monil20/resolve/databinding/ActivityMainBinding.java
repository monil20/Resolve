package com.monil20.resolve.databinding;
import com.monil20.resolve.R;
import com.monil20.resolve.BR;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @NonNull
    public final com.monil20.resolve.login.LoginButton button;
    @NonNull
    ...
    @NonNull
    public final com.monil20.resolve.FlexibleFrameLayout wrapper;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.button = (com.monil20.resolve.login.LoginButton) bindings[3];
        ...
        this.wrapper = (com.monil20.resolve.FlexibleFrameLayout) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.monil20.resolve.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.monil20.resolve.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
