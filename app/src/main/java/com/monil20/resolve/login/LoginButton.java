...
import com.monil20.resolve.OnButtonSwitchedListener;
...
public class LoginButton extends View {
    ...
    private com.monil20.resolve.login.OnSignUpListener onSignUpListener;
    private com.monil20.resolve.login.OnLoginListener onLoginListener;
    ...
    private void init() {
        ...
        loginButtonPaint.setTypeface(typeface);
        ...
        signUpButtonPaint.setTypeface(typeface);
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        loginTextOutline.offset(width / 2 - (loginTextOutline.right + loginTextOutline.left) / 2, (int) dpToPixels(450));
        signUpTextOutline.offset(width / 2 - (signUpTextOutline.right + signUpTextOutline.left) / 2, (int) dpToPixels(450));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isLogin) {
            canvas.drawText(getString(R.string.sign_up), width / 2, dpToPixels(450), signUpPaint);
        } else {
            canvas.drawText(getString(R.string.login), width / 2, dpToPixels(450), loginPaint);
        }
...
//        animator.setInterpolator(new AccelerateInterpolator());
        animator.addUpdateListener(animation -> {
            ...
            if (isLogin) {
                ...
                currentLoginY = startLoginY - ((startLoginY - dpToPixels(450)) * fraction);
                ...
                currentSignUpTextY = startSignUpTextY - ((startSignUpTextY - dpToPixels(450)) * fraction);
    ...
    public void setOnSignUpListener(com.monil20.resolve.login.OnSignUpListener listener) {
        onSignUpListener = listener;
    }

    public void setOnLoginListener(com.monil20.resolve.login.OnLoginListener listener) {
